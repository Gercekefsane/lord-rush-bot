...
Your **FID** is displayed on the player info screen. It's a number like `123456789`.

<!-- TODO: Add actual screenshots -->
<!--
![Step 1 - Main Screen](images/fid-step1-lords-rush.png)
![Step 2 - Tap Avatar](images/fid-step2-lords-rush.png)
![Step 3 - Copy FID](images/fid-step3-lords-rush.png)
-->
...
Replace `123456789` with your actual FID. The bot will then ask for your **kingdom number**.

The bot will:
1. Store your FID and kingdom number
2. Register you in your alliance's member list
3. Start redeeming gift codes for you automatically — one signed call per code, no captcha, no login
...
[![Contact Support](https://img.shields.io/badge/Contact%20Support-Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/btuncsiper)
